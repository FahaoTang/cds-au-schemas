...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BankingAccountFee : IEquatable<BankingAccountFee>
    { 
        /// <summary>
        /// Name of the fee
        /// </summary>
        ...
        /// <summary>
        /// The amount charged for the fee. Assumed to be in AUD. One of amount, balanceRate, transactionRate and accruedRate is mandatory
        /// </summary>
        /// <value>The amount charged for the fee. Assumed to be in AUD. One of amount, balanceRate, transactionRate and accruedRate is mandatory</value>
        [DataMember(Name="amount")]
        public string Amount { get; set; }

        /// <summary>
        /// A fee rate calculated based on a proportion of the balance. Assumed to be in AUD. One of amount, balanceRate, transactionRate and accruedRate is mandatory
        /// </summary>
        /// <value>A fee rate calculated based on a proportion of the balance. Assumed to be in AUD. One of amount, balanceRate, transactionRate and accruedRate is mandatory</value>
        [DataMember(Name="balanceRate")]
        public string BalanceRate { get; set; }

        /// <summary>
        /// A fee rate calculated based on a proportion of a transaction. Assumed to be in AUD. One of amount, balanceRate, transactionRate and accruedRate is mandatory
        /// </summary>
        /// <value>A fee rate calculated based on a proportion of a transaction. Assumed to be in AUD. One of amount, balanceRate, transactionRate and accruedRate is mandatory</value>
        ...
        /// </summary>
        /// <value>A fee rate calculated based on a proportion of the calculated interest accrued on the account. One of amount, balanceRate, transactionRate and accruedRate is mandatory</value>
        [DataMember(Name="accruedRate")]
        public string AccruedRate { get; set; }

        /// <summary>
        /// The indicative frequency with which the fee is calculated on the account. Only applies if accruedRate is also present. Formatted according to [ISO 8601 Durations](https://en.wikipedia.org/wiki/ISO_8601#Durations)
        /// </summary>
        /// <value>The indicative frequency with which the fee is calculated on the account. Only applies if accruedRate is also present. Formatted according to [ISO 8601 Durations](https://en.wikipedia.org/wiki/ISO_8601#Durations)</value>
        [DataMember(Name="accrualFrequency")]
        ...
        public List<BankingAccountDiscount> Discounts { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BankingAccountFee {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BankingAccountFee)obj);
        }

        /// <summary>
        /// Returns true if BankingAccountFee instances are equal
        /// </summary>
        /// <param name="other">Instance of BankingAccountFee to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankingAccountFee other)
        {
        ...
        public static bool operator ==(BankingAccountFee left, BankingAccountFee right)
        {
