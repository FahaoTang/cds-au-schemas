...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BankingLoanAccount : IEquatable<BankingLoanAccount>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>The expected or required repayment frequency. Formatted according to [ISO 8601 Durations](https://en.wikipedia.org/wiki/ISO_8601#Durations)</value>
        [DataMember(Name="repaymentFrequency")]
        public string RepaymentFrequency { get; set; }

        /// <summary>
        /// The reason for taking out the loan. The purpose generally affects the rate offered due to different risk profiles
        /// </summary>
        /// <value>The reason for taking out the loan. The purpose generally affects the rate offered due to different risk profiles</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BankingLoanAccount)obj);
        }
        ...
        public static bool operator ==(BankingLoanAccount left, BankingLoanAccount right)
        {
